...
/**
 * inorder_successor - Returns the minimum value of a binary search trees.
...
/**
 * bst_delete - Deletes a node from a binary search trees.
...
/**
 * bst_remove_recursive - Removes a node from a binary search trees recursively.
 * @root: A pointer to the root node of the BST to remove a node from file.
...
/**
 * bst_remove - Removes a node from a binary search trees.
