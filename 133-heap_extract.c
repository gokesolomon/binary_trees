...
/**
 * tree_height - measures the height of a btree
...
/**
 * tree_size_h - measures the sum of heights of a btree
...
/**
 * _preorder - goes through a btree using pre-order traversal
...
/**
 * heap_extract - extracts the root node from a MBH
